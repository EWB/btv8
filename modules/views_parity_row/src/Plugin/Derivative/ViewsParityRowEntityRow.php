...
/**
 * @file
 * Contains \Drupal\views_parity_row\Plugin\Derivative\ViewsParityRowEntityRow.
 */

namespace Drupal\views_parity_row\Plugin\Derivative;
 ...
 */
class ViewsParityRowEntityRow implements ContainerDeriverInterface {
    ...
    foreach ($this->entityManager->getDefinitions() as $entity_type_id => $entity_type) {
      ...
      if (($base_table = $entity_type->getBaseTable()) && $this->viewsData->get($base_table) && $this->entityManager->hasHandler($entity_type_id, 'view_builder')) {
        $this->derivatives[$entity_type_id] = array(
          ...
          'title' => $entity_type->getLabel() . ' (alternate)',
